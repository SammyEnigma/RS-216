...
init()
{
	if(getentarray("player", "classname").size < 6)
		setDvar( "sv_maprotation", "gametype sd map mp_backlot gametype sd map mp_citystreets gametype sd map mp_crash gametype sd map mp_crossfire gametype sd map mp_strike gametype sd map mp_vacant gametype sd map mp_marketcenter gametype sd map mp_nuketown" );
